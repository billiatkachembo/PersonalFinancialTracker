  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        income: "bg-gradient-income text-income-foreground hover:scale-105 shadow-income transition-bounce",
        expense: "bg-gradient-expense text-expense-foreground hover:scale-105 shadow-expense transition-bounce",
        success: "bg-income text-income-foreground hover:bg-income/90 shadow-soft",
        financial: "bg-gradient-primary text-primary-foreground hover:scale-105 shadow-medium transition-bounce",
      },
      size: {
